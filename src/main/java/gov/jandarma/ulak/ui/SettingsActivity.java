...
import gov.jandarma.ulak.services.ExportLogsService;
...
public class SettingsActivity extends XmppActivity implements
	...
	public void onStart() {
		...
		boolean removeLocation = new Intent("gov.jandarma.ulak.location.request").resolveActivity(getPackageManager()) == null;
