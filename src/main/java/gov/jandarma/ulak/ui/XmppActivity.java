...
import gov.jandarma.ulak.entities.Presences;
import gov.jandarma.ulak.services.AvatarService;
import gov.jandarma.ulak.services.BarcodeProvider;
import gov.jandarma.ulak.services.XmppConnectionService;
import gov.jandarma.ulak.services.XmppConnectionService.XmppConnectionBinder;
			...
			nfcAdapter.setNdefPushMessageCallback(new NfcAdapter.CreateNdefMessageCallback() {
				...
				public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
					return new NdefMessage(new NdefRecord[]{
							...
							NdefRecord.createApplicationRecord("gov.jandarma.ulak")
					});
				}
			}, this);
		}
