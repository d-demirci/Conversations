...
import gov.jandarma.ulak.crypto.PgpDecryptionService;
import gov.jandarma.ulak.crypto.PgpEngine;
import gov.jandarma.ulak.crypto.axolotl.AxolotlService;
import gov.jandarma.ulak.crypto.axolotl.FingerprintStatus;
import gov.jandarma.ulak.crypto.axolotl.XmppAxolotlMessage;
import gov.jandarma.ulak.entities.Account;
import gov.jandarma.ulak.entities.Blockable;
import gov.jandarma.ulak.entities.Bookmark;
...
import gov.jandarma.ulak.entities.Message;
import gov.jandarma.ulak.entities.MucOptions;
import gov.jandarma.ulak.entities.MucOptions.OnRenameListener;
import gov.jandarma.ulak.entities.Presence;
import gov.jandarma.ulak.entities.PresenceTemplate;
import gov.jandarma.ulak.entities.Roster;
import gov.jandarma.ulak.entities.ServiceDiscoveryResult;
import gov.jandarma.ulak.entities.Transferable;
import gov.jandarma.ulak.entities.TransferablePlaceholder;
import gov.jandarma.ulak.generator.AbstractGenerator;
import gov.jandarma.ulak.generator.IqGenerator;
import gov.jandarma.ulak.generator.MessageGenerator;
import gov.jandarma.ulak.generator.PresenceGenerator;
import gov.jandarma.ulak.http.HttpConnectionManager;
import gov.jandarma.ulak.http.AesGcmURLStreamHandlerFactory;
import gov.jandarma.ulak.parser.AbstractParser;
import gov.jandarma.ulak.parser.IqParser;
import gov.jandarma.ulak.parser.MessageParser;
import gov.jandarma.ulak.parser.PresenceParser;
import gov.jandarma.ulak.persistance.DatabaseBackend;
import gov.jandarma.ulak.persistance.FileBackend;
import gov.jandarma.ulak.ui.SettingsActivity;
import gov.jandarma.ulak.ui.UiCallback;
import gov.jandarma.ulak.ui.UiInformableCallback;
import gov.jandarma.ulak.utils.ConversationsFileObserver;
import gov.jandarma.ulak.utils.CryptoHelper;
import gov.jandarma.ulak.utils.ExceptionHelper;
import gov.jandarma.ulak.utils.MimeUtils;
import gov.jandarma.ulak.utils.OnPhoneContactsLoadedListener;
import gov.jandarma.ulak.utils.PRNGFixes;
import gov.jandarma.ulak.utils.PhoneHelper;
import gov.jandarma.ulak.utils.ReplacingSerialSingleThreadExecutor;
import gov.jandarma.ulak.utils.Resolver;
import gov.jandarma.ulak.utils.SerialSingleThreadExecutor;
import gov.jandarma.ulak.xml.Namespace;
import gov.jandarma.ulak.utils.XmppUri;
import gov.jandarma.ulak.xml.Element;
import gov.jandarma.ulak.xmpp.OnBindListener;
import gov.jandarma.ulak.xmpp.OnContactStatusChanged;
import gov.jandarma.ulak.xmpp.OnIqPacketReceived;
import gov.jandarma.ulak.xmpp.OnKeyStatusUpdated;
import gov.jandarma.ulak.xmpp.OnMessageAcknowledged;
import gov.jandarma.ulak.xmpp.OnMessagePacketReceived;
import gov.jandarma.ulak.xmpp.OnPresencePacketReceived;
import gov.jandarma.ulak.xmpp.OnStatusChanged;
import gov.jandarma.ulak.xmpp.OnUpdateBlocklist;
import gov.jandarma.ulak.xmpp.Patches;
import gov.jandarma.ulak.xmpp.XmppConnection;
import gov.jandarma.ulak.xmpp.chatstate.ChatState;
...
import gov.jandarma.ulak.xmpp.jingle.JingleConnectionManager;
import gov.jandarma.ulak.xmpp.jingle.OnJinglePacketReceived;
import gov.jandarma.ulak.xmpp.jingle.stanzas.JinglePacket;
import gov.jandarma.ulak.xmpp.mam.MamReference;
import gov.jandarma.ulak.xmpp.pep.Avatar;
...
public class XmppConnectionService extends Service {
	...
	private void restoreFromDatabase() {
		synchronized (this.conversations) {
			...
			Log.d(Config.LOGTAG,"restoring ulak...");
			...
			Log.d(Config.LOGTAG,"finished restoring ulak in "+diffConversationsRestore+"ms");
