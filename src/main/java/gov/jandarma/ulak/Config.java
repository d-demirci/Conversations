...
public final class Config {
	...
	public static final String LOGTAG = "ulak";

	public static final String BUG_REPORTS = "bugs@xmpp.whitehat.blog";


	public static final String DOMAIN_LOCK = null; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "xmpp.whitehat.blog";
